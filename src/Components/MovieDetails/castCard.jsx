function CastCard({ name, img, character }) {
  ...
  return (
    <div className="min-w-[140px] w-[140px] pb-2.5 overflow-hidden border border-gray-500  h-full  shadow-lg cursor-pointer rounded-md">
      <img
        src={img !== null ? `${base_url}${img}` : defaultImage}
        height={175}
